...
export default function Cursor() {
    ...
    return (
        <>
            <div ref={dotOutline} className={`cursor-big-circle ${mouseActive ? "active-cursor-big-circle" : "inactive-cursor-big-circle"} `} >

            </div>
            <div ref={dot} className={`cursor-small-circle ${mouseActive ? "active-cursor-small-circle" : "inactive-cursor-small-circle"}`}  >
